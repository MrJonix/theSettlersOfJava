...
public class TradeUIController {
    ...
    public void openTradeDialog() {
        ...
        StackPane close = createCloseableContent(content, () -> FXGL.getGameScene().removeUINode(overlay));
    ...
    public void openHarbourTrade() {
        ...
        Node closable = createCloseableContent(content, () -> FXGL.getGameScene().removeUINode(overlay));
    ...
    public void showTradeOfferOverlay(Player targetPlayer, TradeOffer offer) {
        ...
        StackPane overlay = createCloseableContent(fullContent, () -> FXGL.getGameScene().removeUINode(FXGL.geto("tradeOverlay")));
